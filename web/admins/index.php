...
if ($mod== "login")
{
	...
	$sql ="select username, hoten from quantri where username=:u and matkhau= :p ";
	$arr = array(":u"=>$u, ":p"=>$p);
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<div id="profile-links">
				Hello, <a href="#" title="Edit your profile">[<?php echo $_SESSION["admin_data"]["hoten"];?>]</a><br />
				<?php if(isset($_SESSION["admin_login"]) ) {?> 
				<a href="index.php?mod=logout"> Thoát </a>
               <?php } ?>
				<br />
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<?php
							...
							$classBook = $classCat=$classPub =$classOrder="";
							if ($g=="cat") $classCat =" current";
							if ($g=="book") $classBook =" current";
							if ($g=="pub") $classPub =" current";
							if ($g=="order") $classOrder =" current";
						?>
				<li> 
					<a href="#" class="nav-top-item <?php if($mod =='book') echo "current";?>"> <!-- Add the class "current" to current menu item -->
					Quản lý sản phẩm
		      </a>
					<ul>
				...
				<li>
					<a href="#" class="nav-top-item <?php echo $classOrder;?>">
						Đơn hàng
					</a>
					<ul>
